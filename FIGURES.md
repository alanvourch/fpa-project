...
- The committed executive summary was written to the narrative step's prompt without a model call and passed the same grounding check. Source: header of `output/executive_summary.md`.

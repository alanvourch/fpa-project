...
def render_report(fc, adjustments, growth, df, cutoff, horizon):
    ...
    lines += [
        ...
        "effect is carried forward in this run — if one had been (see the "
...
def main():
    ...
    with open(REPORT_PATH, "w", encoding="utf-8") as f:
        f.write(render_report(fc, adjustments, growth, df, cutoff, horizon))

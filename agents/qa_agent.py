...
unseen monthly reporting cycle; that file exists in this project purely to validate
...
def main():
    ...
    lines = [
        ...
        "the same way a reviewer would on a real, unseen monthly pack with no answer key.",
        "",
        "## Status",
        "",
